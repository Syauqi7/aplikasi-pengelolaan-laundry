...
$outlet_id = $_SESSION['outlet_id']; // Mengambil outlet_id dari sesi pengguna yang sedang login

$query = "SELECT transaksi.*, transaksi.tgl, member.nama_member, 
                 SUM(detail_transaksi.total_harga) AS total_harga, 
                 outlet.nama_outlet, paket.nama_paket, 
          ...
          WHERE transaksi.outlet_id = '$outlet_id' 
          AND transaksi.status_bayar = 'dibayar'
          GROUP BY transaksi.id_transaksi, transaksi.tgl, member.nama_member, 
                   outlet.nama_outlet, paket.nama_paket"; // Filter berdasarkan outlet yang sedang login
