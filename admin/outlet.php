...
$query = 'SELECT outlet.*, user.nama_user, user.role FROM outlet LEFT JOIN user ON user.outlet_id = outlet.id_outlet';
                            ...
                            <?php foreach($data as $outlet): ?>
                                <tr>
                                    ...
                                    <?php if($outlet['nama_user'] == null){
                                        ...
                                        echo htmlspecialchars($outlet['nama_user']) . ' (' . htmlspecialchars($outlet['role']) . ')';
                                    } ?>
                                    </td>
