...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Feb 2025 pada 03.51
...
(14, 38, 4, 1, 15000, NULL, 20000),
(15, 39, 4, 1, 15000, NULL, NULL);
...
(6, 'Depon Bot', 'Jl. Munjul', 'L', '21893829183912', '2878138321');
...
(33, 'Outlet Gunung', 'gunung', '1231231');
...
(15, 'kiloan', 'Paket Hemat', 12000, 26),
(16, 'kiloan', 'cuci selimut', 10000, 26);
...
(34, 26, 'DRY202502131437', 5, '2025-02-13 01:37:19', '2025-02-20 12:00:00', '2025-02-13 01:37:28', 0, 0, 0, 'baru', 'dibayar', 1),
(35, 26, 'DRY202502130738', 5, '2025-02-13 01:38:12', '2025-02-20 12:00:00', '2025-02-13 02:31:34', 0, 0, 0, 'baru', 'dibayar', 11),
(36, 26, 'DRY202502130459', 6, '2025-02-13 01:59:13', '2025-02-20 12:00:00', '2025-02-13 01:59:28', 0, 0, 0, 'baru', 'dibayar', 1),
(37, 26, 'DRY202502131630', 6, '2025-02-13 02:30:24', '2025-02-20 12:00:00', '2025-02-13 02:30:38', 0, 0, 0, 'baru', 'dibayar', 1),
(38, 26, 'DRY202502131931', 5, '2025-02-13 02:31:23', '2025-02-20 12:00:00', '2025-02-19 05:43:46', 0, 0, 0, 'baru', 'dibayar', 11),
(39, 26, 'DRY202502192543', 6, '2025-02-19 05:43:30', '2025-02-26 12:00:00', NULL, 0, 0, 0, 'baru', 'belum', 1);
...
(11, 'kasirmawar', 'kasirmawar', '202cb962ac59075b964b07152d234b70', 26, 'kasir'),
(16, 'mawar', 'mawar', '202cb962ac59075b964b07152d234b70', 26, 'owner'),
(17, 'sukiyaki', 'sukiyaki', '202cb962ac59075b964b07152d234b70', 33, 'owner'),
(18, 'suki', 'suki', '202cb962ac59075b964b07152d234b70', 33, 'kasir');
...
--
ALTER TABLE `paket`
  ADD CONSTRAINT `paket_ibfk_1` FOREIGN KEY (`outlet_id`) REFERENCES `outlet` (`id_outlet`) ON DELETE CASCADE;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`outlet_id`) REFERENCES `outlet` (`id_outlet`) ON DELETE CASCADE;
COMMIT;
